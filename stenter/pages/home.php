            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td colspan="2"><select name="proses" id="proses" required>
                            <option value="">Pilih</option>
                            <?php
                            $qry1 = mysqli_query($con, "SELECT proses, jns FROM tbl_proses WHERE ket='stenter' ORDER BY proses ASC");
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <input name="lot" type="text" id="lot" size="5" value="<?= $lot; ?>" /></td>
                </tr>
                <tr>
                    <td scope="row">
                        <h4>Roll</h4>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <input name="rol" type="text" id="rol" size="3" placeholder="0" pattern="[0-9]{1,}" value="<?= $rol; ?>" /></td>
                </tr>
                <tr>
                    <td scope="row">
                        <h4>Mulai Proses</h4>
