    ...
    <fieldset>
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="1%">:</td>
          <td colspan="2"><select name="shift" id="shift" required onchange="window.location='?typekk='+document.getElementById(`typekk`).value+'&idkk='+document.getElementById(`nokk`).value+'&demand='+document.getElementById(`demand`).value+'&shift='+this.value">
        ...
        <tr>
          ...
          <td colspan="2">
            <select name="shift2" id="shift2" required="required" onchange="window.location='?typekk='+document.getElementById(`typekk`).value+'&idkk='+document.getElementById(`nokk`).value+'&demand='+document.getElementById(`demand`).value+'&shift=<?php echo $_GET['shift']; ?>&shift2='+this.value">
              <option value="">Pilih</option>
              <option value="1" <?php if ($_GET['shift2'] == "1") {
                                  echo "SELECTED";
                                } ?>>1</option>
              <option value="2" <?php if ($_GET['shift2'] == "2") {
                                  echo "SELECTED";
                                } ?>>2</option>
              <option value="3" <?php if ($_GET['shift2'] == "3") {
                                  echo "SELECTED";
                                } ?>>3</option>
            </select>
          </td>
        ...
        <tr>
          ...
          <td colspan="2"><select name="nama_mesin" id="nama_mesin" onchange="myFunction();" required="required">
              <option value="">Pilih</option>
              <?php
              $qry1 = mysqli_query($con, "SELECT nama FROM tbl_mesin WHERE jenis='stenter' ORDER BY nama ASC");
              while ($r = mysqli_fetch_array($qry1)) {
              ?>
        ...
        <tr>
          ...
          <td colspan="2"><select name="no_mesin" id="no_mesin" onchange="myFunction();" required="required">
              <option value="">Pilih</option>
              <?php
              $qry1 = mysqli_query($con, "SELECT no_mesin FROM tbl_no_mesin WHERE jenis='stenter' ORDER BY no_mesin ASC");
              while ($r = mysqli_fetch_array($qry1)) {
              ?>
