<?php
    if (isset($_POST['cari_delivery'])) {
        ...
        $tgl1            = $_POST['tgl1'];
        $tgl2            = $_POST['tgl2'];
        header("Location: dye_harian.php?nomesin=$nomesin&jenismesin=$jenismesin&tgl1=$tgl1&tgl2=$tgl2");
    }
?>
<?php require_once 'header.php'; ?>
<title><?php $title = "DYE - Filter Laporan Harian"; echo $title; ?></title>
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="nav-icon fas fa-search"></i> FILTER PENCARIAN LAPORAN HARIAN DYEING</h1>
            </div>
            <div class="col-sm-6">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="nomesin" class="form-control" style="width: 100%;" onChange="window.location='http://10.0.0.10/laporan/dye_filter.php?jnsmsn='+this.value" required>
                                        ...
                                        <select name="jenismesin" class="form-control" style="width: 100%;">
                                            ...
                                            <?php 
                                                ...
                                                $sqlDB2="SELECT
                                                            ...
                                                            WHERE
                                                                r.TYPE = '2' AND w.COSTCENTERCODE = 'C019' AND w.CODE = '$namamesin'
                                                            ORDER BY r.CODE ASC";
