<?php
    if (isset($_POST['cari_delivery'])) {
        ...
        $tgl1            = $_POST['tgl1'];
        $tgl2            = $_POST['tgl2'];
        header("Location: fin_harian.php?nomesin=$nomesin&jenismesin=$jenismesin&tgl1=$tgl1&tgl2=$tgl2");
    }
?>
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="nomesin" class="form-control" style="width: 100%;" onChange="window.location='http://10.0.0.10/laporan/fin_filter.php?jnsmsn='+this.value" required>
                                            <option disabled>Pilih Jenis Mesin</option>
                                            <?php 
                                        ...
                                        <select name="jenismesin" class="form-control" style="width: 100%;">
                                            ...
                                            <?php 
                                                ...
                                                $sqlDB2="SELECT
                                                            ...
                                                            WHERE
                                                                r.TYPE = '2' AND w.COSTCENTERCODE = 'C021' AND w.CODE = '$namamesin'
                                                            ORDER BY r.CODE ASC";
