...
<title><?php $title = "Harian Finishing"; echo $title; ?></title>
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Laporan Harian Finishing</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <table id="harian-fin" class="table table-bordered table-striped">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th align="center" rowspan="2">Suhu</th>
                                    <th align="center" rowspan="2">Speed</th>
                                ...
                                <tr>
                                    <th align="center">Lebar (inch)</th>
                                    <th align="center">Gramasi (g/m2)</th>
                                    <th align="center">Lebar (inch)</th>
                                    <th align="center">Gramasi (g/m2)</th>
                                ...
                                <?php
                                    ...
                                    if ($nomesin = "All") {
                                        $sqlDB2 = "SELECT
                                                ...
                                                WHERE
                                                    p.OPERATIONCODE IN ('CPT1','DRY1','FIN1','FIN2','FNJ1','JHP1','LIP1','OPW1','OVN1','PAD1','PDR1','PRE1')
                                                AND
